...
convert line.png  no-child.png no-child-last.png minus.png minus-hover.png minus-last.png minus-last-hover.png plus.png plus-hover.png plus-last.png plus-last-hover.png ok-default.png cancel-disabled.png ok.png cancel.png check0.gif check1.gif check2.gif  h-line.png line.png +append ../treeview-sprite.png
