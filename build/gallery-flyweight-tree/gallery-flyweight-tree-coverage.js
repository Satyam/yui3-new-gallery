...
return type;
        ...
        _poolFetch: function(iNode) {
            ...
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_poolFetch", 378);
...
return this._createNode(iNode);
        ...
        _poolReturn: function (fwNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_poolReturn", 405);
...
pool.push(fwNode);
        ...
        _createNode: function (iNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_createNode", 425);
...
return null;
         ...
         */
        getRoot: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getRoot", 453);
...
return this._poolFetch(this._tree).hold();
        ...
        _findINodeByElement: function(el) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_findINodeByElement", 463);
...
var id = el.ancestor(DOT + FWNode.CNAMES.CNAME_NODE, true).get('id'),
                found = null,
                scan = function (iNode) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "scan", 466);
...
return null;
        ...
        _poolFetchFromEvent: function (ev) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_poolFetchFromEvent", 488);
...
return null;
        ...
        _forSomeINode: function(fn, scope) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_forSomeINode", 507);
...
var loop = function(iNode, depth) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "loop", 509);
...
return YArray.some(iNode.children || [], function(childINode, index) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 9)", 510);
...
return loop(this._tree, 0);
        ...
        forSomeNodes: function (fn, scope) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forSomeNodes", 530);
...
var root = this.getRoot(),
                forOneLevel = function (fwNode, depth) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forOneLevel", 534);
...
fwNode.forSomeChildren(function (fwNode, index, array) {
                        _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 10)", 535);
...
return ret;
        ...
        _focusedNodeGetter: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_focusedNodeGetter", 552);
...
return this._poolFetch(this._focusedINode).hold();
        ...
        _focusedNodeSetter: function (value) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_focusedNodeSetter", 562);
...
this._focusOnINode(newINode);
                _yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 566);
return newINode;
            } else {
...
return Y.Attribute.INVALID_VALUE;
        ...
        _focusOnINode: function (iNode) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_focusOnINode", 577);
...
var prevINode = this._focusedINode,
                ...
                expand = function (iNode) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "expand", 581);
...
self._focusedINode = iNode;
        ...
        _dynamicLoaderSetter: function (value) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_dynamicLoaderSetter", 615);
...
this._forSomeINode(function(iNode) {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 11)", 620);
...
*/
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 704);
FWNode = Y.Base.create(
	FWNODE_NAME,
	Y.Base,
	[],
	{
        ...
        initializer: function (cfg) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "initializer", 730);
...
this.after('labelChange', this._afterLabelChange);
        ...
        _buildCfgPatch: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_buildCfgPatch", 741);
...
YArray.each(this._classes, function (c) {
                _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 12)", 743);
...
this.forSomeChildren( function (fwNode, index, array) {
						_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 13)", 786);
...
return Lang.sub(templ, attrs);
		...
		_slideTo: function (iNode) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_slideTo", 822);
...
this._stateProxy = iNode;
        ...
        hasChildren: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "hasChildren", 833);
...
return !!(children && children.length);
		...
		**/
		forSomeChildren: function(fn, scope) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "forSomeChildren", 846);
...
YArray.some(children, function (iNode, index, array) {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 14)", 852);
...
return ret;
        ...
        _afterLabelChange: function (ev) {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_afterLabelChange", 866);
...
el.setHTML(ev.newVal);
		...
		_expandedGetter: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_expandedGetter", 882);
...
return this._iNode.expanded !== false;
		...
		_afterExpandedChange: function (ev) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_afterExpandedChange", 894);
...
iNode.expanded = value;
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 905);
...
return;
			...
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 909);
if (el) {
...
el.set('aria-expanded', String(value));
		...
		_loadDynamic: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_loadDynamic", 928);
...
root.get(DYNAMIC_LOADER).call(root, self, Y.bind(self._dynamicLoadReturn, self));
		...
		_dynamicLoadReturn: function (response) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_dynamicLoadReturn", 941);
...
self._renderChildren();
				...
				_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 953);
iNode.isLeaf = true;
			}
...
Y.one('#' + iNode.id).replaceClass(CNAMES.CNAME_LOADING, (iNode.isLeaf?CNAMES.CNAME_NOCHILDREN:CNAMES.CNAME_EXPANDED));
		...
		_renderChildren: function (el) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_renderChildren", 966);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 967);
var s = '',
				iNode = this._iNode,
                depth = this.get('depth');
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 970);
iNode._childrenRendered = true;
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 971);
this.forSomeChildren(function (fwNode, index, array) {
				_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "(anonymous 15)", 971);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 972);
s += fwNode._getHTML(index, array.length, depth + 1);
			});
...
el.setHTML(s);
		 ...
		 */
		hold: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "hold", 983);
...
return (this._iNode._held = this);
		 ...
		 */
		release: function () {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "release", 993);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 994);
...
return this;
		 ...
		 */
		getParent: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getParent", 1005);
...
return (iNode?this._root._poolFetch(iNode).hold():null);
		...
		getNextSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getNextSibling", 1016);
...
if (index === 0 || index >= siblings.length) {
				_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1021);
return null;
			}
...
return this._root._poolFetch(siblings[index]).hold();
		...
		getPreviousSibling: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getPreviousSibling", 1032);
...
return this._root._poolFetch(siblings[index]).hold();
         ...
         */
        focus: function() {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "focus", 1046);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1047);
return this._root.set(FOCUSED, this);
         ...
         */
        blur: function () {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "blur", 1054);
...
return this._root.set(FOCUSED, null);
		 ...
		 */
		toggle: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "toggle", 1062);
...
return this.set(EXPANDED, !this.get(EXPANDED));
         ...
         */
        expand: function() {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "expand", 1070);
...
return this.set(EXPANDED, true);
         ...
         */
        collapse: function() {
            _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "collapse", 1078);
...
return this.set(EXPANDED, false);
		 ...
		 */
		isRoot: function() {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "isRoot", 1086);
...
return this._root._tree === this._iNode;
		...
		*/
		_getStateVal : function(name) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_getStateVal", 1098);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1099);
var iNode = this._iNode;
			_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1100);
...
return this._state.get(name, VALUE);
		...
		*/
		_setStateVal : function(name, value) {
			_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "_setStateVal", 1118);
...
if (this._state.get(name, BYPASS_PROXY) || this._state.get(name, 'initializing') || !iNode) {
				_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1121);
 ...
 */       },
		ATTRS: {
			...
			root: {
				...
				readOnly: true,
				getter: function() {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 1238);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1239);
return this._root;
				}
			},
			...
			id: {
				validator: function () {
                    _yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "validator", 1274);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1275);
return !this.get('rendered');
			...
			depth: {
				...
				readOnly: true,
				getter: function () {
					_yuitest_coverfunc("build/gallery-flyweight-tree/gallery-flyweight-tree.js", "getter", 1288);
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1289);
var count = 0,
						iNode = this._iNode;
...
count += 1;
						_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1293);
iNode = iNode._parent;
					}
...
_yuitest_coverline("build/gallery-flyweight-tree/gallery-flyweight-tree.js", 1310);
